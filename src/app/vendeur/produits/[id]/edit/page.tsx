  ...
  const handleSubmit = async () => {
    try {
      ...
      await updateProduct.mutateAsync({
        ...
        minProcessingDays: parseInt(formData.minProcessingDays) || 1,
        maxProcessingDays: parseInt(formData.maxProcessingDays) || 5,
      });
        ...
        <div className="min-h-[60vh] flex items-center justify-center">
          ...
          >
            ...
            <p className="text-neutral-500 mb-8 max-w-md mx-auto">
              Les modifications ont ete enregistrees sur votre produit vendeur
              avec la meme interface riche que cote admin.
            </p>
            <div className="flex gap-4 justify-center">
              <Link href="/vendeur/produits">
                <Button variant="outline">Retour a la liste</Button>
              </Link>
              <Button onClick={() => router.push("/vendeur/produits")}>
                Gerer les produits
              </Button>
            </div>
          </motion.div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-neutral-900">
              Modifier le produit vendeur
            </h1>
            <p className="text-neutral-500">
              Meme interface riche que l&apos;admin, reservee a votre boutique
            </p>
          </div>
        </div>
