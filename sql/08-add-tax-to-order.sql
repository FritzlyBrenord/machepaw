-- =====================================================
-- 08-ADD-TAX-TO-ORDER.SQL
-- Updates create_marketplace_order to support taxes
-- =====================================================

DROP FUNCTION IF EXISTS public.create_marketplace_order(JSONB, JSONB, NUMERIC, TEXT, TEXT, TEXT, TEXT);
